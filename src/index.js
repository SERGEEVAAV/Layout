...
// Adding buttons adding buttons to navigation sheet
let p1 = document.createElement('button');
p1.classList.add('btn-nav__bordered');
p1.innerHTML = 'Sing In';

let p2 = document.createElement('button');
p2.classList.add('btn-nav__colored');
p2.innerHTML = 'Sing Up';


header__navigation.append(p1, p2);
